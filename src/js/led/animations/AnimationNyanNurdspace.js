...
export class AnimationNyanNurdspace extends Animation {
    constructor(matrix) {
        super(matrix);
...
AnimationNyanNurdspace.category = "Memes";
AnimationNyanNurdspace.title = "Nyancat longgggg";
AnimationNyanNurdspace.description = "Based on <a href='https://github.com/bertrik/nyancat/blob/master/nyancat.c'>this</a>";
AnimationNyanNurdspace.presetDir = "Nyancat";
//# sourceMappingURL=AnimationNyanNurdspace.js.map