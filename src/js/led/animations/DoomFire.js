...
export function glow(current, min, max, wildness) {
...
export class DoomFire extends Animation {
    constructor(matrix) {
        ...
        function setFirePixel(pixelIndex, intensity) {
            if (pixelIndex < 0)
                return;
...
DoomFire.category = "Fire";
DoomFire.title = "Doom";
DoomFire.description = "Pixel art from the game, based on <a href='https://github.com/filipedeschamps/doom-fire-algorithm/blob/master/playground/render-with-canvas-and-hsl-colors/fire.js'>this.</a>";
DoomFire.presetDir = "Doom";
//# sourceMappingURL=DoomFire.js.map