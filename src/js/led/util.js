...
export function error(title, message, time = 10000) {
    // @ts-ignore
    $("body").toast({
        class: "error",
        title: title,
...
export function info(title, message = "", time = 2000) {
    // @ts-ignore
    $("body").toast({
        class: "info",
        title: title,
 ...
 * @param content
 */
export async function confirmPromise(title, content) {
 ...
 * @param defaultValue
 */
export async function promptPromise(title, content, defaultValue) {
    return new Promise((resolve, reject) => {
        // @ts-ignore
        $('body').modal('prompt', {
            title: title,
